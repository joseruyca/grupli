...
Write-Host "Grupli v16.38 quality gate" -ForegroundColor Cyan
...
if ($Pub -notmatch "version:\s*0\.16\.38\+16380") { throw "pubspec.yaml no está en 0.16.38+16380" }
...
Write-Host "Grupli v16.38 OK" -ForegroundColor Green
